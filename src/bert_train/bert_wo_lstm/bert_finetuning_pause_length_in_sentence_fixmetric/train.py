...
def run_training(cfg):
    ...
    run_name = f"{str(cfg.dataset.pause_time_threshold_ms)}ms_{cfg.dataset.preprocess_type}_{cfg.model.num_labels}labels_maxlen[{cfg.training.max_length_train}.{cfg.training.max_length_val}.{cfg.training.max_length_test}]_addFC"
